...
const AppsIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <rect width="20" height="20" fill="url(#pattern0_80_695)" />
    <defs>
      <pattern id="pattern0_80_695" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlinkHref="#image0_80_695" transform="scale(0.01)" />
      </pattern>
      <image
        id="image0_80_695"
        width="100"
